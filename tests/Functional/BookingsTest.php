...
class BookingsTest extends ApiTestCase
{
    use ReloadDatabaseTrait;
    /**
     * Test creating Booking with no data
     */
    public function testCreateBookingsNoData()
    {
    ...
    /**
     * Test creating Booking with invalid CNP
     */
    public function testCreateBookingsInvalidCnp()
    {
    ...
    /**
     * Test creating Booking with valid CNP
     */
    public function testCreateBookingsValidCNP()
    {
        $client = self::createClient();
    ...
    /**
     * Test creating Booking with programs overlaps
     */
    public function testCreateBookingsProgramOverlap()
    {
        $client = self::createClient();
